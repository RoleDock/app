...
class JobRequirement {
    ...
    @Column(columnDefinition = "text") String rawText;
    @Enumerated(EnumType.STRING) @Column(nullable = false, length = 20)
    JobOfferReviewDtos.RequirementSource source = JobOfferReviewDtos.RequirementSource.LLM_EXTRACTED;
    ...
    @Enumerated(EnumType.STRING) @Column(length = 20) ExtractionConfidence extractionConfidence;
    ...
    JobOfferReviewDtos.CurrentRequirement toData() {
        return new JobOfferReviewDtos.CurrentRequirement(id, source, rawText, canonicalLabel, category, requirementKind, centrality,
